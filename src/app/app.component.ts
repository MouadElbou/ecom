...
@Component({
  ...
  template: `
    <nz-layout class="min-h-screen">
      <!-- Header only shows when URL includes /client -->
      <nz-header *ngIf="isClientRoute" class="w-full z-50 bg-white shadow-md sticky top-0" [@slideDown]>
...
export class AppComponent {
  ...
  constructor(
    ...
    this.router.events.pipe(
      ...
      this.isClientRoute = event.url.includes('/client');
    });
